 ...
 */
@Singleton
class CommitmentLockManager @Inject constructor(
     ...
     */
    suspend fun sendOtp(toEmail: String, random: Random = Random.Default): SendOtpResult {
...
sealed interface SendOtpResult {
    data class Sent(val expiresAtMs: Long) : SendOtpResult
    data class Cooldown(val waitMs: Long) : SendOtpResult
