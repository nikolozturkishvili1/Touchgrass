 ...
 */
@Singleton
class InstagramReelsDetector @Inject constructor() : Detector {
     ...
     */
    private fun classifyByViewIds(root: AccessibilityNodeInfo, pkg: String): String? {
    ...
    companion object {
         ...
         */
        @JvmStatic
        internal val REELS_CLASS_HINTS: Array<Pair<String, String>> = arrayOf(
         ...
         */
        @JvmStatic
        internal val REELS_VIEW_IDS: Array<Pair<String, String>> = arrayOf(
