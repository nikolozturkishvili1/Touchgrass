...
class FacebookReelsDetector
    ...
    constructor() : Detector {
        ...
        // Distinct early returns per Facebook feed-surface variant read clearer than nesting.
         ...
         */
        private fun logFacebookDiagnostics(
            event: AccessibilityEvent,
            root: AccessibilityNodeInfo?,
        ) {
        ...
        companion object {
             ...
             */
            @JvmStatic
            internal val REELS_VIEWER_CLASS_HINTS: Array<String> =
                arrayOf(
                    "ReelsViewerActivity",
                    "ReelsWatchFragment",
                    "WatchReelFragment",
             ...
             */
            @JvmStatic
            internal val REELS_TAB_CLASS_HINTS: Array<String> =
                arrayOf(
                    "ReelsTabFragment",
                    "ReelsFeedFragment",
                    "WatchFeedFragment",
             ...
             */
            @JvmStatic
            internal val NEWS_FEED_CLASS_HINTS: Array<String> =
                arrayOf(
                    "NewsFeedFragment",
                    "NewsFeedActivity",
                    "com.facebook.feed",
             ...
             */
            @JvmStatic
            internal val REELS_VIEW_IDS: Array<String> =
                arrayOf(
                    "reels_video_player",
